...
- [ ] Added Fenton solitary wave generation from the internal mass source (JianmingChen@ShanghaiMaritimeUniversity)  
- [ ] Added the high fidelity Clamond and Fructus (2003) solitary wave generation from the internal mass source and left boundary (JianmingChen@ShanghaiMaritimeUniversity)  
 
 ---
### 3.5 UPDATE_0005
**Date**: 2026/01/04  
**Description**  
- [x] Merge the **`repo:fengyanshi/NHWAVE_IBM`** with the previous **UPDATES**